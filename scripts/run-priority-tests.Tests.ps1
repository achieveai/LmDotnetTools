...
try {
    ...
    Assert-True ($repositoryPlan.declarationSummary.known -eq 10162 -and $repositoryPlan.declarationSummary.reviewed -eq 10162) "Every known .NET/script declaration must have exactly one reviewed policy row."
    ...
    foreach ($tier in @(@("P0", 305), @("P1", 7776), @("P2", 1951), @("P3", 130))) {
