...
try {
    ...
    Assert-True ($repositoryPlan.declarationSummary.known -eq 10283 -and $repositoryPlan.declarationSummary.reviewed -eq 10283) "Every known .NET/script declaration must have exactly one reviewed policy row."
    ...
    foreach ($tier in @(@("P0", 347), @("P1", 7844), @("P2", 1957), @("P3", 135))) {
