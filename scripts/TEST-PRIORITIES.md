...
The checked-in manifest classifies **10,139 known .NET method families and atomic script tests**:
P0 335, P1 7,650, P2 2,008 and P3 146. Each reviewed declaration carries its exact inventory ID and
