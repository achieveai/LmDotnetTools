...
The checked-in manifest classifies **9,766 known .NET method families and atomic script tests**:
P0 274, P1 7,518, P2 1,847 and P3 127. Each reviewed declaration carries its exact inventory ID and
