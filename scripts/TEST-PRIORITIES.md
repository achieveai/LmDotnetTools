...
The checked-in manifest classifies **10,508 known .NET method families and atomic script tests**:
P0 347, P1 7,981, P2 2,034 and P3 146. Each reviewed declaration carries its exact inventory ID and
