...
The checked-in manifest classifies **10,470 known .NET method families and atomic script tests**:
P0 347, P1 7,955, P2 2,022 and P3 146. Each reviewed declaration carries its exact inventory ID and
