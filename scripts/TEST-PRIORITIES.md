...
The checked-in manifest classifies **10,531 known .NET method families and atomic script tests**:
P0 348, P1 8,003, P2 2,034 and P3 146. Each reviewed declaration carries its exact inventory ID and
