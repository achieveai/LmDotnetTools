...
The checked-in manifest classifies **9,978 known .NET method families and atomic script tests**:
P0 290, P1 7,659, P2 1,900 and P3 129. Each reviewed declaration carries its exact inventory ID and
