...
The checked-in manifest classifies **10,840 known .NET method families and atomic script tests**:
P0 416, P1 8,183, P2 2,092 and P3 149. Each reviewed declaration carries its exact inventory ID and
