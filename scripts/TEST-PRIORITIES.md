...
The checked-in manifest classifies **9,823 known .NET method families and atomic script tests**:
P0 278, P1 7,555, P2 1,863 and P3 127. Each reviewed declaration carries its exact inventory ID and
