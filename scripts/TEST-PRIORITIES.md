...
The checked-in manifest classifies **10,821 known .NET method families and atomic script tests**:
P0 416, P1 8,169, P2 2,087 and P3 149. Each reviewed declaration carries its exact inventory ID and
