...
The checked-in manifest classifies **10,872 known .NET method families and atomic script tests**:
P0 416, P1 8,207, P2 2,100 and P3 149. Each reviewed declaration carries its exact inventory ID and
