...
The checked-in manifest classifies **10,175 known .NET method families and atomic script tests**:
P0 335, P1 7,676, P2 2,017 and P3 147. Each reviewed declaration carries its exact inventory ID and
