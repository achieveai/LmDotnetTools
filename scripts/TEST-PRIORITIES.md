...
The checked-in manifest classifies **10,302 known .NET method families and atomic script tests**:
P0 348, P1 7,859, P2 1,960 and P3 135. Each reviewed declaration carries its exact inventory ID and
