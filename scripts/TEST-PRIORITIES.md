...
The checked-in manifest classifies **10,909 known .NET method families and atomic script tests**:
P0 418, P1 8,231, P2 2,110 and P3 150. Each reviewed declaration carries its exact inventory ID and
