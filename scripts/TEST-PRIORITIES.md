...
The checked-in manifest classifies **10,551 known .NET method families and atomic script tests**:
P0 348, P1 8,014, P2 2,043 and P3 146. Each reviewed declaration carries its exact inventory ID and
