...
public class CommandLineOptions
{
    [Option(
        ...
        "prompt",
        Required = false,
        Default = "Hello! Can you help me with a task?",
    ...
    [Option("grok", Required = false, Default = false, HelpText = "Run the OpenAI Grok agentic loop example.")]
    ...
    [Option("claude", Required = false, Default = false, HelpText = "Run the ClaudeAgentSDK one-shot example.")]
    ...
    [Option("max-turns", Required = false, Default = 10, HelpText = "Maximum turns for agentic loop (default: 10).")]
    public int MaxTurns { get; set; } = 10;

    [Option('v', "verbose", Required = false, Default = false, HelpText = "Enable verbose logging output.")]
