...
// Header containment is layout behavior, so ChatClientLayoutRegressionTests verifies it in Chromium
// at 390, 768, 946, and 1280px instead of coupling this unit suite to the header's CSS structure.
