...
/// <summary>
/// UI-facing endpoints that drive the interactive (browser + loopback) GitHub OAuth sign-in
    ...
    ILogger<GitHubAuthController> logger) : ControllerBase
{
    ...
    public async Task<IActionResult> SignIn(CancellationToken ct = default)
    {
        ...
        {
            // Provider is registered but not configured (e.g. missing ClientId / ClientSecret).
