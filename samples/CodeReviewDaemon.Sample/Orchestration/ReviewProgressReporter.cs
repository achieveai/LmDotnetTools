...
internal sealed class ReviewProgressReporter
{
    ...
    /// from "nothing was wrong". Reported on EVERY start, healthy case included, for that same reason: a fleet
    /// with no warnings and a fleet nobody is watching produce the same log.
    /// </para>
    /// </remarks>
