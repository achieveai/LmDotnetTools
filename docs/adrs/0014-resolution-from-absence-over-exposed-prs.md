# ADR 0014: Infer resolution from absence over exposed PRs, and guard it against cohort drift
...
code-derived, consistent with ADR 0012.
...
ever moved or deleted (ADR 0013); it is the concrete payoff of that decision.
