...
public abstract record ToolHandlerResult
{
    ...
    /// </summary>
    public static Resolved FromText(string text) => new(new ToolHandlerResultPayload(text));
    ...
    public string ResultText =>
        this switch
        {
            ...
            _ => throw new InvalidOperationException($"Unknown ToolHandlerResult variant '{GetType().Name}'."),
        };
}
