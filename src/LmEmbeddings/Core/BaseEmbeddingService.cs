...
///     <list type="bullet">
///         <item>
///             <description>Request validation and sanitization</description>
///         </item>
///         <item>
///             <description>API-specific payload formatting</description>
///         </item>
///         <item>
///             <description>Standardized error handling and exception patterns</description>
///         </item>
///         <item>
///             <description>Disposal pattern implementation</description>
///         </item>
///     </list>
///     <para>
...
public abstract class BaseEmbeddingService : BaseHttpService, IEmbeddingService
{
    ...
    ///     Thrown when <paramref name="logger" /> or <paramref name="httpClient" /> is
    ///     null
    /// </exception>
    ...
    ///     <list type="number">
    ///         <item>
    ///             <description>Validates the input sentence</description>
    ///         </item>
    ///         <item>
    ///             <description>Retrieves available models</description>
    ///         </item>
    ///         <item>
    ///             <description>Uses the first available model to generate embeddings</description>
    ///         </item>
    ///         <item>
    ///             <description>Returns the first embedding vector</description>
    ///         </item>
    ///     </list>
    /// </remarks>
    /// <example>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Format the request using <see cref="FormatRequestPayload(EmbeddingRequest)" /></description>
    ///         </item>
    ///         <item>
    ///             <description>Make the HTTP request to the provider's API</description>
    ///         </item>
    ///         <item>
    ///             <description>Parse the response and return a standardized <see cref="EmbeddingResponse" /></description>
    ///         </item>
    ///         <item>
    ///             <description>Handle provider-specific errors appropriately</description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    ///     </para>
    ///     <para>
    ///         For batch processing multiple texts, use
    ///         <see cref="GenerateEmbeddingsAsync(EmbeddingRequest, CancellationToken)" />
    ...
    ///         <item>
    ///             <description>
    ///                 <see cref="EmbeddingApiType.Default" /> → <see cref="FormatOpenAIRequest(EmbeddingRequest)" />
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <see cref="EmbeddingApiType.Jina" /> → <see cref="FormatJinaRequest(EmbeddingRequest)" />
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>normalized</c> - Controls whether embeddings are L2 normalized</description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <c>embedding_type</c> - Specifies the encoding format (maps from
    ///                 <see cref="EmbeddingRequest.EncodingFormat" />)
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>Support for binary and base64 encoding formats</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>encoding_format</c> - Specifies how embeddings are encoded (float, base64)</description>
    ///         </item>
    ///         <item>
    ///             <description><c>user</c> - Optional user identifier for tracking and abuse monitoring</description>
    ///         </item>
    ///         <item>
    ///             <description><c>dimensions</c> - Optional parameter to reduce embedding dimensionality</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Request object is not null</description>
    ///         </item>
    ///         <item>
    ///             <description>Inputs collection is not null or empty</description>
    ///         </item>
    ///         <item>
    ///             <description>Model name is not null or empty</description>
    ///         </item>
    ///         <item>
    ///             <description>All input texts are non-empty</description>
    ///         </item>
    ///         <item>
    ///             <description>Service is not disposed</description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 API-specific parameters are valid (via
    ///                 <see cref="ValidateApiSpecificParameters(EmbeddingRequest)" />)
    ///             </description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///         <item>
    ///             <description>
    ///                 <see cref="EmbeddingApiType.Jina" /> → <see cref="ValidateJinaParameters(EmbeddingRequest)" />
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <see cref="EmbeddingApiType.Default" /> →
    ///                 <see cref="ValidateOpenAIParameters(EmbeddingRequest)" />
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    protected virtual void ValidateApiSpecificParameters(EmbeddingRequest request)
    {
        ...
        switch (request.ApiType)
        {
            ...
            case EmbeddingApiType.Default:
                ...
                break;
            default:
                throw new ArgumentException($"Unsupported API type: {request.ApiType}", nameof(request));
        }
    }
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>float</c> - Standard floating-point array</description>
    ///         </item>
    ///         <item>
    ///             <description><c>binary</c> - Binary encoded embeddings</description>
    ///         </item>
    ///         <item>
    ///             <description><c>base64</c> - Base64 encoded embeddings</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///         </item>
    ///         <item>
    ///             <description><c>base64</c> - Base64 encoded embeddings (default)</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ///         The validation is case-insensitive and will throw a descriptive exception
