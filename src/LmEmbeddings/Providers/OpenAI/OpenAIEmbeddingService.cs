...
///     <list type="bullet">
///         <item>
///             <description>Support for all OpenAI embedding models with automatic size detection</description>
///         </item>
///         <item>
///             <description>Configurable API endpoints and authentication</description>
///         </item>
///         <item>
///             <description>JSON serialization with snake_case naming policy for OpenAI API compatibility</description>
///         </item>
///         <item>
///             <description>Automatic encoding format handling (base64, float)</description>
///         </item>
///         <item>
///             <description>Comprehensive error handling and retry mechanisms</description>
///         </item>
///         <item>
///             <description>Organization-level API key support</description>
///         </item>
///     </list>
///     <para>
...
public class OpenAIEmbeddingService : BaseEmbeddingService
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Bearer token authentication using the provided API key</description>
    ///         </item>
    ///         <item>
    ///             <description>Base address set to the configured OpenAI endpoint</description>
    ///         </item>
    ///         <item>
    ///             <description>JSON serialization with snake_case naming policy</description>
    ///         </item>
    ///         <item>
    ///             <description>Organization header if specified in options</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>text-embedding-3-small: 1536 dimensions</description>
    ///         </item>
    ///         <item>
    ///             <description>text-embedding-3-large: 3072 dimensions</description>
    ///         </item>
    ///         <item>
    ///             <description>text-embedding-ada-002: 1536 dimensions</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>text-embedding-3-small</c>: 1536 dimensions (default)</description>
    ///         </item>
    ///         <item>
    ///             <description><c>text-embedding-3-large</c>: 3072 dimensions</description>
    ///         </item>
    ///         <item>
    ///             <description><c>text-embedding-ada-002</c>: 1536 dimensions (legacy)</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Automatic request validation using base class validation methods</description>
    ///         </item>
    ///         <item>
    ///             <description>OpenAI-specific payload formatting with snake_case JSON serialization</description>
    ///         </item>
    ///         <item>
    ///             <description>Retry logic with exponential backoff for transient failures</description>
    ///         </item>
    ///         <item>
    ///             <description>Support for both base64 and float encoding formats</description>
    ///         </item>
    ///         <item>
    ///             <description>Comprehensive error handling for OpenAI API responses</description>
    ///         </item>
    ///         <item>
    ///             <description>Usage statistics parsing from API responses</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="number">
    ///         <item>
    ///             <description><c>text-embedding-3-small</c> - Latest small model, good balance of performance and cost</description>
    ///         </item>
    ///         <item>
    ///             <description><c>text-embedding-3-large</c> - Latest large model, highest performance</description>
    ///         </item>
    ///         <item>
    ///             <description><c>text-embedding-ada-002</c> - Legacy model, maintained for compatibility</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>Auto-detection</c> - Automatically detects base64 strings vs float arrays</description>
    ///         </item>
    ///         <item>
    ///             <description><c>Explicit override</c> - Respects explicit format specification when provided</description>
    ///         </item>
    ///         <item>
    ///             <description><c>Comprehensive validation</c> - Validates that specified format matches actual data</description>
    ///         </item>
    ///         <item>
    ///             <description><c>Clear error messages</c> - Provides detailed context when format mismatches occur</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ...
    ///     <list type="number">
    ///         <item>
    ///             <description>If encodingFormat is explicitly specified, use it (with validation)</description>
    ///         </item>
    ///         <item>
    ///             <description>If data is JsonElement with Array ValueKind, treat as float array</description>
    ///         </item>
    ///         <item>
    ///             <description>If data is string or JsonElement with String ValueKind, treat as base64</description>
    ///         </item>
    ///         <item>
    ///             <description>Otherwise, throw descriptive error with detected type information</description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    ///     <list type="number">
    ///         <item>
    ///             <description>Decodes the base64 string to a byte array</description>
    ///         </item>
    ///         <item>
    ///             <description>Converts the byte array to a float array using block copy</description>
    ///         </item>
    ///         <item>
    ///             <description>Returns the resulting float array with the embedding values</description>
    ///         </item>
    ///     </list>
    ///     <para>
