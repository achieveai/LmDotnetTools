...
public interface ILmCoreToAgUiConverter
{
    ...
    ImmutableList<Message> ConvertMessage(IMessage message);
    ...
    ImmutableList<Message> ConvertMessageHistory(IEnumerable<IMessage> messages);
    ...
    ToolCall ConvertToolCall(LmCore.Messages.ToolCall toolCall);
}
