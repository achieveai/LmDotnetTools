...
public record ConsolePrinterColors
{
    ...
    /// </summary>
    public ConsoleColorPair TextMessageColor { get; init; } =
        new() { Foreground = ConsoleColor.White };

    /// <summary>
    /// Color for system messages
    /// </summary>
    public ConsoleColorPair ReasoningMessageColor { get; init; } =
        new() { Foreground = ConsoleColor.DarkGreen };

    /// <summary>
    /// Color for usage messages
    /// </summary>
    public ConsoleColorPair UsageMessageColor { get; init; } =
        new() { Foreground = ConsoleColor.DarkGray };

    /// <summary>
    /// Color for tool use messages
    /// </summary>
    public ConsoleColorPair ToolUseMessageColor { get; init; } =
        new() { Foreground = ConsoleColor.Cyan };

    /// <summary>
    /// Color for tool result messages
    /// </summary>
    public ConsoleColorPair ToolResultMessageColor { get; init; } =
        new() { Foreground = ConsoleColor.Green };

    /// <summary>
    /// Color for single horizontal separator lines
    /// </summary>
    public ConsoleColorPair HorizontalLineColor { get; init; } =
        new() { Foreground = ConsoleColor.DarkGray };

    /// <summary>
    /// Color for double horizontal separator lines at the end of a response
    /// </summary>
    public ConsoleColorPair CompletionLineColor { get; init; } =
