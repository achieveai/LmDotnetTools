...
public sealed class PrLifecycleSweepSeamTests
{
    ...
    {
        var github = new MockPrProvider("github", [], Cursor("github"))
        {
            PrState = new PrStatus(PrLifecycle.Merged, PrDraftState.Unknown),
        };
        var ado = new MockPrProvider("ado", [], Cursor("ado"))
        {
            PrState = new PrStatus(PrLifecycle.Abandoned, PrDraftState.Unknown),
        };
