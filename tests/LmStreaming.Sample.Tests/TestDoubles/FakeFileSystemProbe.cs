...
internal sealed class FakeFileSystemProbe : IFileSystemProbe
{
    ...
    public FakeFileSystemProbe(IEnumerable<string>? executablesOnPath = null, IEnumerable<string>? existingFiles = null)
    {
        _executablesOnPath = new HashSet<string>(executablesOnPath ?? [], StringComparer.OrdinalIgnoreCase);
