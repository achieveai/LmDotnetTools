...
public sealed class SubAgentIntelligenceOptionsTests
{
    ...
    public void Appsettings_TierLadderIsPopulatedForEverySupportedTier()
    {
        ...
        // SubAgentModelResolverTests.Appsettings_*). Every tier is pinned to a model already in the live
        // catalog, so the ladder is populated without putting anything unroutable in front of a sub-agent.
