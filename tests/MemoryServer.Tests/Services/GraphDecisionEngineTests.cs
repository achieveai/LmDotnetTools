...
public class GraphDecisionEngineTests
{
        ...
        List<GraphDecisionOperation> expectedOperations)
    {
        ...
        Debug.WriteLine($"Extracted entities: {extractedEntities.Count}, relationships: {extractedRelationships.Count}");
        ...
        var instructions = await _decisionEngine.AnalyzeGraphUpdatesAsync(
            extractedEntities, extractedRelationships, sessionContext);
        ...
        string expectedReasoningContains)
    {
        ...
        Debug.WriteLine($"Existing: {existingRelationship.Source} --[{existingRelationship.RelationshipType}]--> {existingRelationship.Target} (conf: {existingRelationship.Confidence})");
        Debug.WriteLine($"New: {newRelationship.Source} --[{newRelationship.RelationshipType}]--> {newRelationship.Target} (conf: {newRelationship.Confidence})");

        // Act
        var instruction = await _decisionEngine.ResolveRelationshipConflictAsync(
            existingRelationship, newRelationship, sessionContext);
    ...
    private void SetupRepositoryMocks(List<Entity> existingEntities, List<Relationship> existingRelationships, SessionContext sessionContext)
    {
        // Setup entity lookups
        foreach (var entity in existingEntities)
        {
            _mockRepository.Setup(r => r.GetEntityByNameAsync(entity.Name, sessionContext, It.IsAny<CancellationToken>()))
                          .ReturnsAsync(entity);
        }

        // Setup relationship lookups
        _mockRepository.Setup(r => r.GetRelationshipsAsync(sessionContext, It.IsAny<int>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
        ...
        _mockRepository.Setup(r => r.GetEntityByNameAsync(It.Is<string>(name => !existingEntityNames.Contains(name)), sessionContext, It.IsAny<CancellationToken>()))
    ...
    public static IEnumerable<object[]> GraphUpdateAnalysisTestCases => new List<object[]>
    {
        new object[]
        {
            ...
            new List<Entity>
            {
                new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 0.8f },
                new Entity { Name = "Pizza", Type = "food", UserId = "user123", Confidence = 0.9f }
            },
            ...
            new List<GraphDecisionOperation> { GraphDecisionOperation.ADD, GraphDecisionOperation.ADD, GraphDecisionOperation.ADD }
        },
        new object[]
        {
            ...
            new List<Entity>
            {
                new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 0.9f }, // Higher confidence
                new Entity { Name = "Alice", Type = "person", UserId = "user123", Confidence = 0.8f } // New entity
            },
            new List<Relationship>(),
            new List<Entity>
            {
                new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.7f } // Lower confidence
            },
            new List<Relationship>(),
            new SessionContext { UserId = "user123" },
    ...
    public static IEnumerable<object[]> EntityConflictTestCases => new List<object[]>
    {
        new object[]
        {
            "Higher confidence new entity",
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.6f },
        ...
        new object[]
        {
            ...
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.9f },
            new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 0.6f },
            new SessionContext { UserId = "user123" },
        ...
        new object[]
        {
            ...
            new Entity { Id = 1, Name = "Entity", Type = "unknown", UserId = "user123", Confidence = 0.8f },
            new Entity { Name = "Entity", Type = "person", UserId = "user123", Confidence = 0.8f },
            new SessionContext { UserId = "user123" },
            GraphDecisionOperation.UPDATE,
            "type refinement"
        },
        new object[]
        {
            ...
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.8f },
    ...
    public static IEnumerable<object[]> RelationshipConflictTestCases => new List<object[]>
    {
        new object[]
        {
            "Higher confidence new relationship",
            new Relationship { Id = 1, Source = "John", RelationshipType = "likes", Target = "Pizza", UserId = "user123", Confidence = 0.6f },
            new Relationship { Source = "John", RelationshipType = "likes", Target = "Pizza", UserId = "user123", Confidence = 0.9f },
            new SessionContext { UserId = "user123" },
            GraphDecisionOperation.UPDATE,
            "higher confidence"
        },
        new object[]
        {
            ...
            new Relationship { Id = 1, Source = "John", RelationshipType = "likes", Target = "Pizza", UserId = "user123", Confidence = 0.9f },
            new Relationship { Source = "John", RelationshipType = "likes", Target = "Pizza", UserId = "user123", Confidence = 0.6f },
            new SessionContext { UserId = "user123" },
            GraphDecisionOperation.NONE,
            "lower confidence"
        },
        new object[]
        {
            ...
            new Relationship { Id = 1, Source = "Alice", RelationshipType = "works_at", Target = "Google", UserId = "user123", Confidence = 0.8f, TemporalContext = null },
            new Relationship { Source = "Alice", RelationshipType = "works_at", Target = "Google", UserId = "user123", Confidence = 0.8f, TemporalContext = "since 2023" },
            new SessionContext { UserId = "user123" },
            GraphDecisionOperation.UPDATE,
            "temporal context"
        }
    ...
    public static IEnumerable<object[]> ConfidenceCalculationTestCases => new List<object[]>
    {
        new object[]
        {
            "High confidence update",
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.7f },
            new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 0.9f },
        ...
        new object[]
        {
            ...
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.3f },
            new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 0.4f },
        ...
        new object[]
        {
            ...
            new Entity { Id = 1, Name = "John", Type = "person", UserId = "user123", Confidence = 0.9f },
            new Entity { Name = "John", Type = "person", UserId = "user123", Confidence = 1.0f },
