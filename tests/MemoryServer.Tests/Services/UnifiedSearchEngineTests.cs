...
public class UnifiedSearchEngineTests
{
    ...
    public async Task SearchAllSourcesAsync_WithValidQuery_ReturnsResults()
    {
        ...
        _mockMemoryRepository.Setup(x => x.SearchAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(mockMemories);

        _mockGraphRepository.Setup(x => x.SearchEntitiesAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(mockEntities);

        _mockGraphRepository.Setup(x => x.SearchRelationshipsAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<CancellationToken>()))
        ...
        _output.WriteLine($"Search completed: {results.TotalResults} total results in {results.Metrics.TotalDuration.TotalMilliseconds}ms");
    }
    ...
    public async Task SearchAllSourcesAsync_WithVectorSearch_CallsVectorMethods()
    {
        ...
        _mockMemoryRepository.Setup(x => x.SearchVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<VectorSearchResult>());

        _mockGraphRepository.Setup(x => x.SearchEntitiesVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new List<EntityVectorSearchResult>());

        _mockGraphRepository.Setup(x => x.SearchRelationshipsVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()))
        ...
        _mockGraphRepository.Verify(x => x.SearchRelationshipsVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()), Times.Once);
    ...
    public async Task SearchAllSourcesAsync_WithPreGeneratedEmbedding_SkipsEmbeddingGeneration()
    {
        ...
        // Act
        var results = await _unifiedSearchEngine.SearchAllSourcesAsync(query, preGeneratedEmbedding, sessionContext, options);
    ...
    public async Task SearchAllSourcesAsync_WithDisabledOptions_SkipsDisabledSearches()
    {
        ...
        _mockMemoryRepository.Verify(x => x.SearchAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()), Times.Never);
        _mockMemoryRepository.Verify(x => x.SearchVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()), Times.Never);
        _mockGraphRepository.Verify(x => x.SearchEntitiesAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Never);
        _mockGraphRepository.Verify(x => x.SearchEntitiesVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()), Times.Never);
        _mockGraphRepository.Verify(x => x.SearchRelationshipsAsync(It.IsAny<string>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<CancellationToken>()), Times.Never);
        _mockGraphRepository.Verify(x => x.SearchRelationshipsVectorAsync(It.IsAny<float[]>(), It.IsAny<SessionContext>(), It.IsAny<int>(), It.IsAny<float>(), It.IsAny<CancellationToken>()), Times.Never);
