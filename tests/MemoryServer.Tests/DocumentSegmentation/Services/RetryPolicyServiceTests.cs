...
public class RetryPolicyServiceTests
{
  ...
  public void CalculateDelay_WithMaxDelayCap_ShouldNotExceedMaximum()
  {
    ...
    // Assert
    Assert.True(delay.TotalMilliseconds <= _configuration.MaxDelayMs,
  ...
  /// </summary>
  public static IEnumerable<object[]> RetryBehaviorTestCases => new List<object[]>
  {
    new object[] { new HttpRequestException("503 Service Unavailable"), true, "Service unavailable should be retried" },
    new object[] { new HttpRequestException("429 Too Many Requests"), true, "Rate limiting should be retried" },
    new object[] { new HttpRequestException("401 Unauthorized"), false, "Authentication errors should not be retried" },
    ...
    new object[] { new ArgumentException("Invalid argument"), true, "Generic errors should be retried by default" }
  };
