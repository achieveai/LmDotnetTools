...
public sealed class CopilotModelsResponseTests
{
    ...
    public void EnumerateModelEntries_unwraps_data_envelope()
    {
        ...
        var ids = CopilotModelsResponse
            .EnumerateModelEntries(Root(json))
    ...
    public void SupportsEndpoint_distinguishes_transports()
    {
        ...
        CopilotModelsResponse
            .SupportsEndpoint(item, CopilotModelsResponse.ResponsesWebSocketEndpoint)
            .Should()
            .BeTrue();
    }
    ...
    {
        CopilotModelsResponse
            .GetSupportedEndpoints(Root("""{ "id": "a" }"""))
            .ValueKind.Should()
            .Be(JsonValueKind.Undefined);
        CopilotModelsResponse
            .GetSupportedEndpoints(Root("""{ "supported_endpoints": "x" }"""))
            .ValueKind.Should()
            .Be(JsonValueKind.Undefined);
    }
    ...
    {
        CopilotModelsResponse.GetString(Root("""{ "id": "claude-opus-4.8" }"""), "id").Should().Be("claude-opus-4.8");
    }
